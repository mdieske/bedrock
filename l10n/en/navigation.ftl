...
navigation-explore-mozilla-labs = Explore { -brand-name-mozilla } Labs

# Outdated string
navigation-mozilla-webvr = { -brand-name-mozilla } WebVR

navigation-view-our-latest = View our latest creations, innovations, and cutting-edge technologies.
